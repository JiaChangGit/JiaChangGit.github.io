...
def main() -> int:
    ...
    priority = ['base-command-feature-lockdown', 'base-flexible-data-placement', 'base-directives-streams', 'admin-io-spec-walkthrough', 'nvm-command-set-1.3', 'base-boot-partitions', 'base-telemetry', 'base-sanitize']
