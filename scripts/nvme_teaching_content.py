...
REPORT_MODULES: dict[str, list[dict]] = {
    ...
    "base-ch4": [
        ...
        },
        {
            ...
            "rows": b([
                ...
                ["SCT", "Status category", "Interpret SCT before looking up SC"], ["SC", "Specific result within the category", "Never interpret without SCT"],
    ...
    "base-power-features": [
        ...
        },
        {
            ...
            "example": b("entry 要在 idle 2000 ms 後進 PS3：ITPT=2000=07D0h，放入 bits31:8 得 0007D000h；ITPS=3，放入 bits7:3 得 18h，所以低 dword=0007D018h。其餘 reserved bits 與 entry 高 dword 保持 0，32 entries 合計 256 bytes。", "To enter PS3 after 2000 ms idle: ITPT=2000=07D0h, shifted into bits31:8 gives 0007D000h; ITPS=3 in bits7:3 gives 18h, so the low dword is 0007D018h. Reserved bits and the entry high dword remain zero; 32 entries total 256 bytes."),
