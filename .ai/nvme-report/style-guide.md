...
2026-09-10 更新：教學 HTML 以逐步解釋、對比與推理帶新手理解；post 正文適合主管
報告，完整技術規則可展開。不得只用相同段落切換折疊狀態，冒充兩種內容深度。
本次保留 10 篇，允許獨立閱讀所需的跨篇背景，同篇不反覆解釋。
...
- 算例列出輸入、換算及結論。確認位移、從 0 起算的數量、直接計數、粒度及單位
  各自使用的規則；NSZE=1000、4 KiB/block 是 4000 KiB，APST 範例的低 Dword 為 07D00018h。
