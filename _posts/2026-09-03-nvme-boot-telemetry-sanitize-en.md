...
<div class="topic-map">
<article><span class="axis-number">01</span><h3>Boot Partitions</h3><p class="axis-paragraph"><span class="axis-paragraph-number" aria-label="01-01">01-01</span>Read and update boot images, distinguishing the active partition from write protection.</p></article>
<article><span class="axis-number">02</span><h3>Telemetry</h3><p class="axis-paragraph"><span class="axis-paragraph-number" aria-label="02-01">02-01</span>Understand data areas, snapshot versions, and consistency across segmented reads.</p></article>
<article><span class="axis-number">03</span><h3>Sanitize</h3><p class="axis-paragraph"><span class="axis-paragraph-number" aria-label="03-01">03-01</span>Distinguish targets, methods, background states, and post-sanitization read behavior.</p></article>
</div>

<p class="reader-paragraph"><span class="paragraph-number" aria-label="00.02">00.02.</span>Command completion and background-operation completion can be separate events. Get Log Page retrieves reported data; Get/Set Features query and configure functions. Relevant identifiers and fields are explained where used.</p>
</section>
