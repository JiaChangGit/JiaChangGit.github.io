...
<p>CDW10.SEL selects current=000b, default=001b, saved=010b, or supported capabilities=011b; CDW10.FID selects the Feature. Other SEL encodings are reserved.</p><dl class="term-note" aria-label="Terms in this passage"><div><dt>CDW</dt><dd>Command Dword: a 32-bit unit in a command, followed by its index.</dd></div></dl><details class="source-note"><summary>Sources: Base 2.4 §5.2.12</summary><p>Source: NVME-BASE-2.4, Rev. 2.4, §5.2.12, printed pages 209-210, PDF pages 235-236</p></details>
