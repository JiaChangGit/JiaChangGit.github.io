...
<div class="topic-map">
<article><span class="axis-number">01</span><h3>Command contents: SQE</h3><p class="axis-paragraph"><span class="axis-paragraph-number" aria-label="01-01">01-01</span>Understand command identifiers, opcodes, and data pointers.</p></article>
<article><span class="axis-number">02</span><h3>Completion results: CQE</h3><p class="axis-paragraph"><span class="axis-paragraph-number" aria-label="02-01">02-01</span>Distinguish new entries, command identity, and status codes.</p></article>
<article><span class="axis-number">03</span><h3>Data addresses: PRP/SGL</h3><p class="axis-paragraph"><span class="axis-paragraph-number" aria-label="03-01">03-01</span>Connect memory-page concepts to NVMe data transfers.</p><dl class="term-note" aria-label="Terms in this passage"><div><dt>NVMe</dt><dd>Non-Volatile Memory Express, the specification family for a host interface to a non-volatile-memory subsystem.</dd></div></dl></article>
<article><span class="axis-number">04</span><h3>Other shared structures</h3><p class="axis-paragraph"><span class="axis-paragraph-number" aria-label="04-01">04-01</span>Understand representations for Feature values, identifiers, lists, and text.</p></article>
</div>
...
<p class="reader-paragraph"><span class="paragraph-number" aria-label="00.02">00.02.</span>Command and completion entries are records in queues; data pointers identify the data involved in a transfer. Distinguishing the command record from its transfer data is the starting point for the field layouts.</p>
</section>
