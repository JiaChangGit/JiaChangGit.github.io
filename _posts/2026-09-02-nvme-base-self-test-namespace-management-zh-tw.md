...
<div class="topic-map">
<article><span class="axis-number">01</span><h3>測試與結果</h3><p class="axis-paragraph"><span class="axis-paragraph-number" aria-label="01-01">01-01</span>分清命令完成、測試完成與有效的結果欄位。</p></article>
<article><span class="axis-number">02</span><h3>容量與格式</h3><p class="axis-paragraph"><span class="axis-paragraph-number" aria-label="02-01">02-01</span>理解容量單位、配置粒度及 LBA 格式選擇。</p></article>
<article><span class="axis-number">03</span><h3>Namespace 生命週期</h3><p class="axis-paragraph"><span class="axis-paragraph-number" aria-label="03-01">03-01</span>把建立、附加、刪除與還原視為不同的狀態改變。</p></article>
</div>

<p class="reader-paragraph"><span class="paragraph-number" aria-label="00.02">00.02.</span>Namespace 是控制器呈現給主機的邏輯儲存空間，以 NSID 識別。建立 namespace 與把它附加至 controller 是兩個步驟，不能由其中一步推論另一步已完成。</p><dl class="term-note" aria-label="本段名詞"><div><dt>controller</dt><dd>controller，實作 NVMe 介面、取走 command 並回報 completion 的控制實體。</dd></div><div><dt>namespace</dt><dd>namespace，主機透過 controller 存取的一份已格式化非揮發性容量。</dd></div><div><dt>NSID</dt><dd>Namespace Identifier，controller 用來指向 namespace 的數值 handle；identifier 不等於 namespace 物件本身。</dd></div></dl>
</section>
